          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-center text-balance text-sm sm:text-lg md:text-xl lg:text-2xl leading-relaxed font-medium">
                I&apos;m always open to job opportunities, long-term
                collaborations, or meaningful partnerships.
              </h3>
              <h3 className="text-center text-balance text-sm sm:text-lg md:text-xl lg:text-2xl leading-relaxed font-medium">
                Feel free to reach out — I read every message and will get back
            ...
            <div className="flex flex-col justify-center items-center gap-10 w-full">
                ...
                <CardContent>
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 items-center sm:items-center sm:justify-start">
                    <MapLocationDotIcon
                      width={40}
                      height={40}
                      className="text-primary sm:w-[60px] sm:h-[60px]"
                    />
                    <div className="flex flex-col gap-2 text-center sm:text-left">
                      <h4 className="text-lg md:text-xl uppercase font-medium text-muted-foreground">
                        Address Point
                      </h4>
              ...
              {/* Mail me Card */}
              <Link
                href="mailto:Isaknox.micro@outlook.com"
