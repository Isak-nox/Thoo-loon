  ...
  return (
    <section id="about">
      ...
      <div
        ...
        className="container flex flex-col-reverse xl:flex-row gap-10"
      >
        {/* Left: Content */}
        <div className="flex-1 flex flex-col text-center xl:text-left items-center xl:items-start justify-center gap-4">
          ...
          <p className="text-sm sm:text-xl xl:text-2xl text-balance leading-relaxed">
            with 8+ years of experience building scalable Shopify Plus, Shopify,
            WooCommerce, and headless commerce platforms. Expertise in React,
            Next.js, TypeScript, Node.js, PHP, and API integrations. Proven
            ability to improve site performance, conversions, and customer
            experience through modern architecture, automation, and data-driven
            optimization. Experienced with cloud platforms, CI/CD, and Agile
            development, delivering end-to-end solutions that align technology
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mt-12 w-3/4 xl:w-full">
            <Link href={CV_URL} target="_blank" className="w-full">
              <Button
                variant={"default"}
                className="w-full text-xl sm:text-2xl py-8"
              >
